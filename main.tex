...
\include{./tex/chapter3}		% فصول دوم: مروری بر مطالعات انجام شده
\include{./tex/chapter4}		% فصل سوم: روش تحقیق
\include{./tex/chapter5}		% فصل چهارم: نتایج
\include{./tex/chapter6}		% فصل پنجم: بحث و نتیجه‌گیری
